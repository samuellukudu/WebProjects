...
# Default configuration for UniScholar
DEFAULT_CONFIG = {
    ...
    'scraping': {
        ...
        'session_timeout': 30,
        'max_retries': 3,
        'user_agent': 'UniScholar/1.0 (Educational Data Extraction)'
    },
    ...
    'extraction': {
        ...
        'enable_dynamic_ner': True,
        'enable_search_ner': True,
        'max_blog_universities': 100
    },
    
    # Output configuration
    'output': {
        'save_general_content': True,
